            ...
            if Nhyperpar_m == 3:
                ...
                if Nhyperpar_r == 1:
                    if Nhyperpar_s == 1:
                        ...
                        parshess = lambda m1, m2, z, chi1, chi2, deltaPN, parm1, parm2, parm3, parm4, parm5, parm6, parz1, pars1, pard1, pard2: utils.logdet_stabilizecond(FIM_use - jnp.asarray(vmap(hessian(funder, argnums=(0,1,2,3,4,5)), in_axes=(0,0,0,0,0,0,None,None,None,None,None,None,None,None,None,None))(m1, m2, z, chi1, chi2, deltaPN, parm1, parm2, parm3, parm4, parm5, parm6, parz1, pars1, pard1, pad2)).T)
            ...
            if Nhyperpar_m == 3:
                if Nhyperpar_r == 1:
                    if Nhyperpar_s == 1:
                        ...
                        derivs_all = np.einsum('...ijk,ijk->...i', np.squeeze(np.array((hessian(parshess, argnums=(6,7,8,9,10,11,12)))(parsmass['m1_src'], parsmass['m2_src'], events['z'], parsspin['chi1z'], parsspin['chi2z'], events['deltaPN'], hyperpars_m[0], hyperpars_m[1], hyperpars_m[2], hyperpars_r[0], hyperpars_s[0], hyperpars_d[0], hyperpars_d[0]))), FIM_use)
                    elif Nhyperpar_s == 2:
                        funder = lambda m1, m2, z, chi1, chi2, deltaPN, parm1, parm2, parm3, parz1, pars1, pars2, pard1, pard2: self.mass_function.mass_function(m1, m2, parm1, parm2, parm3, uselog=True) + self.rate_function.rate_function(z, parz1, uselog=True) + self.spin_function.spin_function(chi1, chi2, pars1, pars2, uselog=True) + self.delta_function.delta_function(deltaPN, pard1, pard2, uselog=True)
